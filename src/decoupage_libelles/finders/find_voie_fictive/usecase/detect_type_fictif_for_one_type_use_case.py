...
class DetectTypeFictifForOneTypeUseCase:
    ...
    def __init__(self, generate_information_on_type_ordered_use_case: GenerateInformationOnTypeOrderedUseCase = GenerateInformationOnTypeOrderedUseCase()):
    ...
    def execute(self, voie: InfoVoie, liste_voie_commun: List[str], liste_fictive: List[str]) -> InfoVoie:
        ...
        for type_voie in liste_voie_commun:
            ...
            if first_type.type_name == type_voie and first_type.is_in_penultimate_position and first_type.word_before and first_type.word_after in liste_fictive + ["L", "D", "A"]:
                return voie
