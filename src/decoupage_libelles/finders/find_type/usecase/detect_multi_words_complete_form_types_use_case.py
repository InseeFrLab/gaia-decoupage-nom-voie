    ...
    def execute(self, type_detect: str, type_lib: str, type_finder_object: TypeFinderObject) -> TypeFinderObject:
        ...
        for pos in pos_debut:
            ...
            if type_detect not in types_detected:
                type_finder_object.voie_big.types_and_positions[(type_detect, 1)] = (pos_type, pos_type + nb_words_in_type - 1)
            else:
                type_finder_object.voie_big.types_and_positions[(type_detect, 2)] = (pos_type, pos_type + nb_words_in_type - 1)
