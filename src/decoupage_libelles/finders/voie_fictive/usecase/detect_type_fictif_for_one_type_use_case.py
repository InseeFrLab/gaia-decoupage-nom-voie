...
class DetectTypeFictifForOneTypeUseCase:
    ...
    def execute(self, voie: InfoVoie, liste_voie_commun: List[str], liste_fictive: List[str]) -> Optional[InfoVoie]:
        ...
        for type_voie in liste_voie_commun:
            ...
            if first_type.type_name == type_voie and first_type.is_in_penultimate_position and not voie.has_type_in_first_pos and first_type.word_after in liste_fictive + ["L", "D"]:
                return voie
        return None
