...
from decoupage_libelles.finders.type.usecase.determin_min_and_max_str_use_case import DeterminMinAndMaxStrUseCase
...
class RemoveWrongDetectionsUseCase:
    def __init__(
        self,
        determin_min_and_max_str_use_case: DeterminMinAndMaxStrUseCase = DeterminMinAndMaxStrUseCase(),
        ...
        self.determin_min_and_max_str_use_case: DeterminMinAndMaxStrUseCase = (
            determin_min_and_max_str_use_case
        )
    ...
    def execute(self, type_finder_object: TypeFinderObject) -> TypeFinderObject:
        ...
        while i < len(types_and_positions):
            ...
            if type_i_name != type_i1_name:
                ...
                type_min, type_max = self.determin_min_and_max_str_use_case.execute(type_i_name, type_i1_name)
