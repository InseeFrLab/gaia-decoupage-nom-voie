...
from handle_voies_two_types.domain.usecase.compl_immeuble_before_type_use_case import CompleImmeubleBeforeTypeUseCase
...
class HandleTwoTypesComplUseCase:
    ...
    def __init__(self,
                 ...
                 compl_immeuble_before_type_use_case: CompleImmeubleBeforeTypeUseCase,
        ...
        self.compl_immeuble_before_type_use_case: CompleImmeubleBeforeTypeUseCase = compl_immeuble_before_type_use_case
