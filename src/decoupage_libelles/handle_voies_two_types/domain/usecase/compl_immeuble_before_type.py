...
class CompleImmeubleBeforeType:
    def __init__(self,
    ...
    def execute(self, voie_compl: InfoVoie) -> InfoVoie:
        ...
        if (first_type.type_name in ComplementFinderUseCase.TYPES_COMPLEMENT_1_2 and
                voie_compl.has_type_in_first_pos and
                voie_compl.has_type_in_second_pos and
                second_type.type_name in ComplementFinderUseCase.TYPES_COMPLEMENT_IMMEUBLE):
