...
class HandleNoTypeComplUseCase:
    def __init__(
        ...
        self.generate_information_on_type_ordered_use_case = generate_information_on_type_ordered_use_case
        self.assign_lib_compl_use_case = assign_lib_compl_use_case
        self.assign_type_lib_use_case = assign_type_lib_use_case
        self.assign_compl_type_lib_use_case = assign_compl_type_lib_use_case
    ...
    def execute(self, voie_compl: InfoVoie) -> VoieDecoupee:
        ...
        # NLP toujours activé ici : nécessaire pour has_adj_det_before
