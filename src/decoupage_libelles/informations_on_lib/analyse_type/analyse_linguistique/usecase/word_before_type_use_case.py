...
class WordBeforeTypeUseCase:
    ...
    def execute(self, infolib: InfoLib, information_on_type_ordered: InformationOnTypeOrdered):
        type_ordered = self.order_type_in_lib_use_case.execute(infolib, information_on_type_ordered.order_in_lib)
        ...
        if position_type_in_lib_start or position_type_in_lib_start > 0:
            ...
            information_on_type_ordered.word_before = infolib.label_preproc[index_word_before]
