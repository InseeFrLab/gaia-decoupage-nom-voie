...
from decoupage_libelles.informations_on_type_in_lib.usecase.type_is_agglomerant_use_case import TypeIsAgglomerantUseCase
from decoupage_libelles.informations_on_type_in_lib.usecase.type_is_longitudinal_use_case import TypeIsLongitudinalUseCase
...
class GenerateInformationOnTypeOrderedUseCase:
    ...
    def __init__(
        ...
        type_is_agglomerant_use_case: TypeIsAgglomerantUseCase = TypeIsAgglomerantUseCase(),
        type_is_longitudinal_use_case: TypeIsLongitudinalUseCase = TypeIsLongitudinalUseCase(),
