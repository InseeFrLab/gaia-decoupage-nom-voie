...
from config.injection_manager import ConfigurerInjection
...
def run():
    ...
    injector = Injector(ConfigurerInjection())
    typevoiedetector: TypeVoieDecoupageLauncher = injector.get(TypeVoieDecoupageLauncher)
